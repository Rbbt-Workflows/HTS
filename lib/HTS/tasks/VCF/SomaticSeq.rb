...
module HTS
  ...
  extension :vcf
  task :somatic_seq => :text do |tumor_bam_file,normal_bam_file,genome_reference,mutect2_vcf,varscan_snv,somaticsniper_vcf,muse_vcf,strelka_snv|
